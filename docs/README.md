...
| [30_distribution.md](30_distribution.md) | verified installation, release signatures/provenance/SBOM and how to check them, reproducible archives, package-manager manifests and explicit self-update |
